...
class ProfileRequest {
  ...
  *updateGenerator() {
    ...
    if (intersectedNodes.length > 0) {
      ...
      if (this.temporaryResult.size() > 100) {
        ...
        //TODO: onProgress on what kind of callback
        //@ts-ignore
    ...
    if (this.priorityQueue.size() === 0) {
      ...
      //TODO: onFinish on what kind of callback
      //@ts-ignore
  ...
  *getPointsInsideProfile(nodes, target) {
  ...
  cancel() {
    //TODO: events on callback doesn't exist
    //@ts-ignore
