  ...
  constructor(viewer) {
    ...
    let createPlaneMaterial = img => {
      ...
      new THREE.TextureLoader().load(
        ...
        "/static/resources/textures/navigation/" + img,
        function(texture) {
    ...
    this.front.updateMatrixWorld(true);
    this.front.name = "F";
    this.add(this.front);
    ...
    this.back.updateMatrixWorld(true);
    this.back.name = "B";
    this.add(this.back);
    ...
    this.bottom.updateMatrixWorld(true);
    this.bottom.name = "D";
