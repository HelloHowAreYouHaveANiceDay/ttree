...
class ClippingTool extends EventDispatcher {
  ...
  setScene(scene) {
    ...
    if (this.scene) {
      ...
      //   this.onRemove
      // );
      // Remove listeners removes all of the same name
      this.scene.removeEventListeners("clip_volume_added");
      this.scene.removeEventListeners("clip_volume_removed");
      this.scene.removeEventListeners("polygon_clip_volume_added");
      this.scene.removeEventListeners("polygon_clip_volume_removed");
    }
  ...
  startInsertion(args = {}) {
    ...
    let svg = $(`
		<svg height="${canvasSize.height}" width="${
      canvasSize.width
