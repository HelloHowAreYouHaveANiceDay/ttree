...
class Utils {
  ...
  static getMousePointCloudIntersection(
    ...
    let pickParams: MousePointParams = {};
  ...
  static projectedRadiusOrtho(radius, proj, screenWidth, screenHeight) {
    ...
    let t1 = new THREE.Vector3(p1.x, p1.y, p1.z);
    let t2 = new THREE.Vector3(p2.x, p2.y, p2.z);
    t1.x = (t1.x + 1.0) * 0.5 * screenWidth;
    t1.y = (t1.y + 1.0) * 0.5 * screenHeight;
    t2.x = (t2.x + 1.0) * 0.5 * screenWidth;
    t2.y = (t2.y + 1.0) * 0.5 * screenHeight;
