...
interface MapView {
  ...
  mapProjection: proj4.ProjectionDefinition;
  sceneProjection: any;
  extentsLayer: any;
  cameraLayer: any;
  toolLayer: any;
  ...
  enabled: boolean;
  createAnnotationStyle: Function;
  ...
  map: ol.Map;
  olCenter?: any;
  dragBoxLayer?: ol.layer.Vector;
  onPointcloudAdded: Function;
  ...
  gExtent: ol.geom.LineString;
  gCamera: ol.geom.LineString;
}
