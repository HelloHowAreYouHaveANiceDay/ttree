...
import { CameraMode } from "./Presets";
...
interface Scene {
  ...
  measurements?: any[];
  volumes?: Volume[];
  polygonClipVolumes?: PolygonClipVolume[];
...
class Scene extends EventDispatcher {
  ...
  getActiveCamera() {
    return this.cameraMode == CameraMode.PERSPECTIVE
      ? this.cameraP
      : this.cameraO;
  }
  ...
  initialize() {
    ...
    this.cameraScreenSpace.lookAt(
      ...
      //TODO: vector 3 cannot be a number
      // @ts-ignore
...

    {
      ...
      //TODO: this is covered in the docs
      //@ts-ignore
  ...
  addAnnotation(position, args: AnnotationArgs = {}) {
