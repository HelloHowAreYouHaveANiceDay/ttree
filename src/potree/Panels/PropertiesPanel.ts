...
import { PointShape, PointSizeType } from "../Presets";
					...
					<li>
						...
						<!--
							<span style="flex-grow: 1;">
								<img id="gradient_spectral" class="button-icon" style="max-width: 100%" src="${"/static/resources"}/icons/gradients_spectral.png" />
							</span>
							<span style="flex-grow: 1;">
								<img id="gradient_yellow_green" class="button-icon" style="max-width: 100%" src="${"/static/resources"}/icons/gradients_yellow_green.png" />
							</span>
							<span style="flex-grow: 1;">
								<img class="button-icon" style="max-width: 100%" src="${"/static/resources"}/icons/gradients_plasma.png" />
							</span>
							<span style="flex-grow: 1;">
								<img class="button-icon" style="max-width: 100%" src="${"/static/resources"}/icons/gradients_grayscale.png" />
							</span>
							<span style="flex-grow: 1;">
								<img class="button-icon" style="max-width: 100%" src="${"/static/resources"}/icons/gradients_rainbow.png" />
							</span>
							-->
						</div>
					</li>
...
e
...

    {
      ...
      let update = () => {
        attributeSelection
          .val(Utils.toMaterialName(material.pointColorType))
          //@ts-ignore
          .selectmenu("refresh");
      };
...

    {
      let schemes = [
        {
          name: "SPECTRAL",
          icon: `/static/resources/icons/gradients_spectral.png`
        },
        {
          name: "YELLOW_GREEN",
          icon: `${"/static/resources"}/icons/gradients_yellow_green.png`
        },
        {
          name: "PLASMA",
          icon: `${"/static/resources"}/icons/gradients_plasma.png`
        },
        {
          name: "GRAYSCALE",
          icon: `${"/static/resources"}/icons/gradients_grayscale.png`
        },
        {
          name: "RAINBOW",
          icon: `${"/static/resources"}/icons/gradients_rainbow.png`
        }
      ];
...

    {
      ...
      panel.find("#sldIntensityRange").slider({
        ...
        slide: (event, ui) => {
          let min =
            Number(ui.values[0]) === 0
              ? 0
              : //@ts-ignore
                //@ts-ignore
                parseInt(Math.pow(2, 16 * ui.values[0]));
          //@ts-ignore
