...
class ClipVolume extends THREE.Object3D {
  ...
  constructor(args) {
    ...
    this.name = "clip_volume_" + this.counter;
    ...
    let boxFrameGeometry = new THREE.Geometry();
    {
      ...
      // TODO: vector3 can't be pushed into a color type;
      // @ts-ignore
    ...
    let createArrow = (name: string, direction: THREE.Vector3, color) => {
