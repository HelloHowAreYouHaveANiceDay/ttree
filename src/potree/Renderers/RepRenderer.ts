...
export interface RepRenderer {
  viewer: Viewer;
  edlMaterial: any;
  attributeMaterials: any[];
  rtColor: any;
  gl: any;
  ...
  rtShadow: THREE.WebGLRenderTarget;
  debugPlane: any;
}

export class RepRenderer {
  constructor(viewer) {
    this.viewer = viewer;
  ...
  resize() {
    ...
    let frustumScale = this.viewer.moveSpeed * 2.0;
